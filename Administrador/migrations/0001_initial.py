# Generated by Django 4.2 on 2023-06-27 20:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ruta', models.CharField(help_text='Directorio local en posicion relativa a la variable de entorno SQUIDPROXYADM_DIRLISTABLOQUEO', max_length=256)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dominio', models.CharField(help_text='Soporta comodines tipo SQL LIKE con el caracter % ó _. Ejemplo: %.gob.mx ó google_.com', max_length=256)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dominio', models.CharField(help_text='Dominio completo no soporta comodines, pero en caso de ser el dominio absoluto bloquea todos los subdominios. Ejemplo: google.com bloquea 123.google.com, abc.google.com, etc.', max_length=256)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(max_length=256)),
                ('filtrar', models.BooleanField(default=True, help_text='Señala si el nivel debe ser procesado por el filtro de sitios web. Para el caso especial del nivel "Sin Filtro"', verbose_name='filtrar')),
                ...
                ('lista_blanca', models.BooleanField(default=False, help_text='Señala si el nivel debe evaluar los sitios como una lista blanca', verbose_name='lista blanca')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mac', models.CharField(db_index=True, help_text='Dirección MAC en formato largo. Ejemplo: A1:B2:C3:D4:E5:F6', max_length=17, validators=[Administrador.models.validate_mac_address], verbose_name='MAC')),
                ('fecha_creacion', models.DateTimeField(blank=True, editable=False, verbose_name='fecha de creacion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mac', models.CharField(help_text='Dirección MAC en formato largo. Ejemplo: A1:B2:C3:D4:E5:F6', max_length=17, unique=True, validators=[Administrador.models.validate_mac_address], verbose_name='MAC')),
                ('fecha_creacion', models.DateTimeField(auto_now_add=True, verbose_name='fecha de creacion')),
