# Generated by Django 4.2 on 2023-06-14 18:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ip', models.CharField(db_index=True, help_text='Dirección IP en formato IPv4 o IPv6. Ejemplo: 192.168.1.254', max_length=45, validators=[django.core.validators.validate_ipv46_address], verbose_name='IP')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre_equipo', models.CharField(blank=True, help_text='Nombre del equipo o Hostname. Ejemplo: PC1, MAC2, IMP3, SRV4, etc.', max_length=256, verbose_name='nombre del equipo')),
                ('tipo_conexion', models.PositiveSmallIntegerField(choices=[(0, 'Otro'), (1, 'Lan'), (2, 'Wlan')], default=1, validators=[django.core.validators.MaxValueValidator(2)], verbose_name='tipo de conexion')),
                ('ip', models.CharField(help_text='Dirección IP en formato IPv4 o IPv6. Ejemplo: 192.168.1.254', max_length=45, unique=True, validators=[django.core.validators.validate_ipv46_address], verbose_name='IP')),
